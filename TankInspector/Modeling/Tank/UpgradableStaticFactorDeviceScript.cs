...
{
	internal class UpgradableStaticFactorDeviceScript : EquipmentScript
    {
	    ...
	    public override string[] EffectiveDomains => new[] {$"{"upgradableStaticFactorDevice"}:{this.AttributeName}"};

	    public UpgradableStaticFactorDeviceScript(Database database)
            : base(database)
        {
